...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.EmbeddedHardDelRepo.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ManualGenStrIdSoftDelRepo.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.AutoGenStrIdHardDelRepo.fragments#0'.
     */
